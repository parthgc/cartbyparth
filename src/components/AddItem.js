...
class AddItem extends React.Component {
    ...
    render() { 
        return (
            <form className="p-3 row d-flex justify-content-center" onSubmit={(e) => { e.preventDefault(); this.props.addItem(this.state.productname, Number(this.state.productprice))}}>
                <div className="col-5">
